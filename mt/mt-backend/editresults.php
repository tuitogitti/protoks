<?php
/*
Kyselyn tulosten muokkaus toteutettuna JSON-editorilla. Tämä
...
if ($_SESSION['ktun'] === $ktun && $_SESSION['ssana'] === $ssana) { ?>
  ...
  <body>
    ...
    <?php
    ?>
    <p class="title">Tulosten muokkaus</p>
    <p>
      <a href='results1.php'>Tulokset</a>
      <a href='results2.php'>Tulosten vertailu</a>
      <a href='editresults.php'>Tulosten muokkaus</a>
      <a href='logout.php'>Kirjaudu ulos</a>
    </p>

    <p>Jos harjoittelet palautekyselyn käyttöä, voit muokata vastausdataa.</p>
    ...
    $data_arr = answersToJsonArray($data);
    ...
    <script>
      ...
      function savejson() {
        ...
        axios.post('saveresults.php', JSON.stringify(jsondata))
          .then(response => {
